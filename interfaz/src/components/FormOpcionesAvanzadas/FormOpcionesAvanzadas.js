    ...
    controlarCambioInput = (event) => {
        switch (event.target.name) {
            case "constDecaimiento":
                this.props.onChange("camposOpcionesAvanzadas","opAv_ConstDecaimiento",event.target.value)
                break;
            case "cantSegmentos":
                this.props.onChange("camposOpcionesAvanzadas","opAv_CantSegmentos",event.target.value)
                break;
            case "cantFrecuencias":
                this.props.onChange("camposOpcionesAvanzadas","opAv_CantFrecuencias",event.target.value)
                break;
            case "frecMaxima":
                this.props.onChange("camposOpcionesAvanzadas","opAv_FrecMaxima",event.target.value)
                break;
            case "cantPasosTemporales":
                this.props.onChange("camposOpcionesAvanzadas","opAv_CantPasosTemp",event.target.value)
                break;
            case "pasoEspacial":
                this.props.onChange("camposOpcionesAvanzadas","opAv_PasoEspacial",event.target.value)
                break;
            case "pasoGrilla":
                this.props.onChange("camposOpcionesAvanzadas","opAv_PasoGrilla",event.target.value)
                break;
            default :
                break;
        }
                        ...
                        <div className="control-group">
                            <div className="flexHorizontalOpcionesAvanzadas">
                                ...
                                <div className = "CajasCentradasOpcionesAvanzadas">
                                    ...
                                    />
                                    <input className="inputMargenInferior PasoEspacialGrilla" 
                                        disabled = {this.props.stateConGrilla}
                                        type="number" 
                                        name="pasoGrilla" 
